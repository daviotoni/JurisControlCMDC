document.addEventListener('DOMContentLoaded', () => {
  ...
  // ===========================================================================
  // ÍNDICE DO app.js  (busque pelos banners "// ===== NOME =====")
  // ---------------------------------------------------------------------------
  // Todo o app roda dentro DESTE closure (escopo privado). Para navegar, procure
  // o banner da seção. Blocos puros já foram extraídos para arquivos irmãos,
  // carregados ANTES deste no index.html e disponíveis aqui como globais:
  //   • js/utils.js ............ helpers puros (fmtBR, parse, sanitizeHTML, ...)
  //   • js/assets.js ........... brasão em base64 (BRASAO_DUQUE_DE_CAXIAS_B64)
  //   • js/fonts-garamond.js ... fonte EB Garamond em base64 (EBGARAMOND_B64)
  //   • js/parecer-modelos.js .. PARECER_TEMPLATES + montagem de Delta do parecer
  //                              (buildParecerDelta, separarTituloEmbutido, ...)
  //
  // Seções deste arquivo, na ordem:
  //   Helpers · Notificações Toast · dbHelper (Firestore) · Perfis de usuário
  //   Editor de Parecer · Modelos por matéria (UI) · Pesquisa de jurisprudência
  //   Busca integrada (Cloud Function juris) · Aba de Jurisprudência
  //   Assistente de IA (Gemini) · Log de Auditoria · Tooltip de anotações
  //   PDF oficial do parecer · Painéis de Configurações (admin) · Gráfico
  //   INICIALIZAÇÃO (init/auth no fim do arquivo)
  // ===========================================================================
